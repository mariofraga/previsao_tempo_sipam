...
class _HomeState extends State<Home> {
  ...
  //CARREGAR INFORMAÃ‡Ã•ES DO JSON DE PREVISÃƒO
  ...
  //FIM CARREGAR INFORMAÃ‡Ã•ES DO JSON DE PREVISÃƒO
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text("PrevisÃ£o do Tempo $cidadeFavorita",
...
Widget LinhaUmidade(String umidadeMax, String umidadeMin) {
  return Padding(
    ...
    child: Column(
      children: <Widget>[
        TituloELinha("UMIDADE MÃX E MÃN"),
...
Widget LinhaVentos(String direcao, String intensidade) {
  return Padding(
    ...
    child: Column(
      children: <Widget>[
        TituloELinha("VENTOS - DIREÃ‡ÃƒO E INTENSIDADE"),
        Descricao("$direcao/$intensidade", "vazia"),
      ],
    ),
  );
}
// WIDGET QUE MONTA A OS DESCRIÃ‡ÃƒO DE CADA MOSTRAGEM
